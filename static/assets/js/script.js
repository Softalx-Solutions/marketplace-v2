...
$(".dark").on('click', function (e) {
	...
	document.getElementById("logo_js").src = "/static/assets/img/logos/leviarts-color.png";
	document.getElementById("logo_js_f").src = "/static/assets/img/logos/leviarts-color.png";
